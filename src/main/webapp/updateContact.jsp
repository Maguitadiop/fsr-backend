...
<form method="post" action="UpdateContactServlet">
		<table>
			<tr>
				<th><h2>Renseignez l'id que vous voulez modifier et les autres champs</h2></th>
				<tr>
				...
				<tr>
					<td><input class="button" type="submit" value="Update" /><input class="button" type="reset" value="Reset"></td>
				</tr>
